  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors',
  {
    variants: {
      variant: {
        ...
        match: 'border-transparent bg-[--color-wolvio-green] text-white',
        gap: 'border-transparent bg-[--color-wolvio-red] text-white',
        opportunity: 'border-transparent bg-[--color-wolvio-amber] text-white',
        insufficient: 'border-transparent bg-[--color-wolvio-slate] text-white',
