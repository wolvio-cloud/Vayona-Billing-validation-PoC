  ...
  return (
    <Tabs defaultValue="parameters" className="w-full">
      <div className="flex justify-center mb-8">
        <TabsList className="bg-[--color-wolvio-surface] border border-[--color-wolvio-slate] p-1.5 rounded-full shadow-[0_4px_20px_rgba(0,0,0,0.2)]">
          <TabsTrigger 
            value="parameters" 
            className="rounded-full px-6 py-2.5 text-sm font-semibold tracking-wide data-[state=active]:bg-[--color-wolvio-orange] data-[state=active]:text-white text-[--color-wolvio-mid] transition-all"
          >
