    ...
    <div className="bg-[--color-wolvio-surface] rounded-[12px] p-6 shadow-[0_4px_20px_rgba(0,0,0,0.3)] flex items-center justify-between border border-[--color-wolvio-slate]">
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <span className="px-2 py-1 bg-[--color-wolvio-navy] border border-[--color-wolvio-slate] text-[--color-wolvio-light] text-xs font-bold uppercase tracking-wider rounded-md">{contractType ?? 'LTSA'}</span>
